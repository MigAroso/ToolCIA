function [ Img_corrected ] = Photobleaching_Correction_PbyP( Img, timeStamps, weights )
...
%  toc
 ...
 %tau_CI = tau - CI(1,3);
  ...
  fun = @(p,t)p(1)*exp(-t/tau)+p(2);
p0 = [1, 1];
N = size(time_profile_Img, 1) * size(time_profile_Img, 2);
t = timeStamps;
y = Img( r, 
tic
parfor r = 1:N
